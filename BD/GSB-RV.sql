...
CREATE TABLE RapportVisite (
  ...
  rap_date_redaction date,
  rap_coeff_confiance int(2),
  mot_code varchar(4) DEFAULT NULL,
  PRIMARY KEY (vis_matricule,rap_num)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO RapportVisite VALUES
	( 'a131' , 1 , '2018-03-01' , 'RAS' , 22,'2018-03-03' , 15 , 'peri') ,
	( 'a131' , 2 , '2018-04-02' , 'RAS' , 22,'2018-04-05' , 12 , 'actu') ,
	( 'a131' , 3 , '2018-04-03' , 'RAS' , 18,'2018-04-06' , 07 , 'peri') ,
	( 'a131' , 4 , '2018-05-10' , 'RAS' , 22,'2018-05-13' , 17 , 'nouv') ,
	( 'a131' , 5 , '2018-05-21' , 'RAS' , 18,'2018-05-23' , 11 , 'info') ;
	
CREATE TABLE Motif (
  mot_code varchar(4) NOT NULL DEFAULT '',
...
ALTER TABLE RapportVisite ADD CONSTRAINT  FK_RAPPORT_VISITE_MOTIF FOREIGN KEY(mot_code) REFERENCES Motif(mot_code) ;
